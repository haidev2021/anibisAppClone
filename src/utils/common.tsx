...
const textCache: Map<TLanguage, Map<TTextPackId, TTextPack>> = new Map();
...
export function trans(key: string, textPack: TTextPack | null): string {
    fLog("textPack", `key = `, key, 'textPack = ', textPack);
...
export function formatDate(value: string | null): string {
    return value ? moment(new Date(value)).format("DD.MM.YYYY").toString() : "";
}
